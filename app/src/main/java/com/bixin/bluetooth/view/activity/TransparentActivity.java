...
import com.bixin.bluetooth.view.TransparentCallDialog;
...
//        setContentView(R.layout.activity_notallhas);
    ...
    public void onEvent(BackgroundHfpStatusEvent event) {
        if (event.status <= HfpStatus.CONNECTED) {
            ...
            ibt_accept.setImageResource(R.drawable.selector_btn_little_qieshengdao);
